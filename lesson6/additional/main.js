...
if(email.includes("@")&&email[0]!=="@"&&(email.indexOf(".")-email.indexOf("@"))>+2&&email.split(".").length===2){
...
//     return((str.split("").filter(value => value==stringsearch).length))
// }
